...
FILES=/labs/mignot/LGI1/LGI1_GWAS/
MERGELIST=/labs/mignot/GPC_LGI1/mergelist.txt
...
do
    ...
    # Merge 
    plink --bfile ${FILES}LGI1_GWAS --bmerge ${FILES}${CHR}_QC \
        --make-bed --out ${FILES}temp 
    mv ${FILES}temp.bim ${FILES}LGI1_GWAS.bim
    mv ${FILES}temp.bed ${FILES}LGI1_GWAS.bed
    mv ${FILES}temp.fam ${FILES}LGI1_GWAS.fam
